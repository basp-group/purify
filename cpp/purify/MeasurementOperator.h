...
public:                                                                                            \
  ...
  PURIFY_MACRO(energy_fraction_chirp, t_real, 0.99999); //energy fraction for chirp by default loss of 1e-6
  PURIFY_MACRO(energy_fraction_wproj, t_real, 1);  //energy fraction for final G
