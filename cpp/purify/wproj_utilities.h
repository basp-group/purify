...
namespace purify {
  namespace wproj_utilities {
    ...
    Vector<t_complex> row_wise_convolution(const Eigen::SparseVector<t_complex> & input_gridding_matrix,  Eigen::SparseVector<t_complex>& Chirp, const t_int& Nx, const t_int& Ny);
